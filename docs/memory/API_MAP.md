...
| GET | `/admin/db-upload` | `admin_db_upload_page` | 544 |
| POST | `/api/admin/db-upload` | `admin_db_upload` | 590 |
| GET | `/api/admin/db-dump` | `admin_db_dump` | 667 |
| GET | `/api/search` | `global_search` | 726 |
| GET | `/api/settings/plan-departament` | `plan_departament_get` | 774 |
| PUT | `/api/settings/plan-departament` | `plan_departament_set` | 785 |
| GET | `/api/calendar` | `calendar_view` | 802 |
