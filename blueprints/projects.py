...
@projects_bp.route('/api/templates', methods=['POST'])
@login_required
def create_template():
    data = request.json
    conn = get_db()
...
@projects_bp.route('/api/templates/<template_id>', methods=['GET'])
@login_required
...
@projects_bp.route('/api/templates/<template_id>', methods=['DELETE'])
@login_required
...
@projects_bp.route('/api/templates/create-from-project/<project_id>', methods=['POST'])
@login_required
...
@projects_bp.route('/api/proiecte/<project_id>/pv/service/preview', methods=['GET'])
@login_required
...
@projects_bp.route('/api/proiecte/<project_id>/pv/service/generate', methods=['POST'])
@login_required
...
@projects_bp.route('/api/proiecte/<project_id>/pv/pif/preview', methods=['GET'])
@login_required
...
@projects_bp.route('/api/proiecte/<project_id>/pv/pif/generate', methods=['POST'])
@login_required
