...
export const MODULE_ORDER = [
  ...
  'cc-baza', 'cc-reglaj', 'cc-drive', 'cc-serie', 'cc-randament',
  ...
  'sincron-turatie', 'sincron-putere', 'sincron-poli-aparenti', 'synrm',
  ...
  'selectie-drive', 'vfd', 'comutatie', 'unda-reflectata', 'ride-through', 'curenti-rulment',
  'dinamica', 'raport-inertie', 'turatie-critica', 'transmisii',
  'surub-bile', 'liniar-raza', 'macara', 'transportor', 'winder', 'frecare',
...
export const MODULES = [
  ...
  // ===================================== P5: SISTEME MECANICE & SARCINI
  {
    ...
    results: [
      { key: 'Tmotor', label: 'Cuplu motor (actionare)', unit: 'Nm', tex: 'T = \\dfrac{F\\,p}{2\\pi\\,\\eta}',
        calc: (v) => (v.F * (v.pas / 1000)) / (2 * Math.PI * (v.eta / 100)), dec: 2 },
      { key: 'Tback', label: 'Cuplu coborare (back-drive)', unit: 'Nm', tex: 'T = \\dfrac{F\\,p\\,\\eta}{2\\pi}',
  ...
  },
  {
    ...
    results: [
      { key: 'T', label: 'Cuplu la ax', unit: 'Nm', tex: 'T = F\\,D/2',
  ...
  },
  {
    ...
    results: [
      ...
      { key: 'Trid', label: 'Cuplu de ridicare', unit: 'Nm', tex: 'T = \\dfrac{m g r}{\\eta}',
        calc: (v) => (v.m * 9.81 * v.r) / (v.eta / 100), dec: 0 },
      { key: 'Tcob', label: 'Cuplu de coborare', unit: 'Nm', tex: 'T = m g r\\,\\eta',
        calc: (v) => v.m * 9.81 * v.r * (v.eta / 100), dec: 0 },
      { key: 'Tment', label: 'Cuplu de mentinere', unit: 'Nm', tex: 'T = m g r',
  ...
  },
  {
    ...
    results: [
      ...
      { key: 'Ttamb', label: 'Cuplu la tambur', unit: 'Nm', tex: 'T = F\\,D/2',
  ...
  },
  {
    ...
    charts: [(v) => ({
      xLabel: 'Diametru d [m]', yLabel: 'Cuplu T [Nm]',
    ...
    results: [
      { key: 'Tplin', label: 'Cuplu la diametru plin', unit: 'Nm', tex: 'T = F\\,d_{plin}/2',
        calc: (v) => (v.F * v.dplin) / 2, dec: 1 },
      { key: 'Tgol', label: 'Cuplu la diametru gol', unit: 'Nm', tex: 'T = F\\,d_{gol}/2',
  ...
  },
  {
    ...
    results: [
      ...
      { key: 'Trun', label: 'Cuplu de mers', unit: 'Nm', tex: 'T_{run} = \\mu_d N r',
        calc: (v, r) => v.mud * r.N * v.r, dec: 2 },
      { key: 'Tbreak', label: 'Cuplu de desprindere', unit: 'Nm', tex: 'T_{break} = k\\,T_{run}',
  ...
  },
  {
    ...
    results: [
      { key: 'Vmax', label: 'Tensiune maxima', unit: 'V', tex: 'V_{max} = U_{dc}/\\sqrt{3}',
        calc: (v) => v.Udc / SQRT3, dec: 1 },
      { key: 'nbaza', label: 'Turatie de baza', unit: 'rpm', tex: 'n_{baza}: \\omega_e=\\dfrac{V_{max}}{\\sqrt{\\psi_m^2+(L_q I_{max})^2}}',
