...
const WEB = {
  induction: W('Induction_motor', 'Induction motor', 'induction motor'),
  affinity: W('Affinity_laws', 'Affinity laws', 'affinity laws'),
  npsh: W('Net_positive_suction_head', 'NPSH', 'Net positive suction head'),
  thd: W('Total_harmonic_distortion', 'Total harmonic distortion', 'total harmonic distortion'),
  pf: W('Power_factor', 'Power factor', 'power factor'),
  dcMotor: W('DC_motor', 'DC motor', 'DC motor'),
  syncMotor: W('Synchronous_motor', 'Synchronous motor', 'synchronous motor'),
  foc: W('Vector_control_(motor)', 'Vector control / FOC', 'Vector control'),
  vfd: W('Variable-frequency_drive', 'Variable-frequency drive', 'variable-frequency drive'),
  centrifugal: W('Centrifugal_pump', 'Centrifugal pump', 'Centrifugal pump'),
  specificSpeed: W('Specific_speed', 'Specific speed', 'Specific speed'),
  shortCircuit: W('Short_circuit', 'Short circuit', 'short circuit'),
  transformer: W('Transformer', 'Transformer', 'transformer'),
  reluctance: W('Reluctance_motor', 'Reluctance motor (SynRM)', 'reluctance motor'),
  inertia: W('Moment_of_inertia', 'Moment of inertia', 'moment of inertia'),
  resonance: W('Resonance', 'Resonance', 'resonance'),
  encoder: W('Rotary_encoder', 'Rotary encoder', 'rotary encoder'),
  pid: W('PID_controller', 'PID controller', 'PID controller'),
  damping: W('Damping', 'Damping ratio', 'damping'),
  inverter: W('Power_inverter', 'Power inverter / IGBT', 'power inverter'),
  cable: W('Voltage_drop', 'Voltage drop', 'voltage drop'),
  flywheel: W('Flywheel', 'Flywheel', 'flywheel'),
  voltageSag: W('Voltage_sag', 'Voltage sag', 'voltage sag'),
  powerQuality: W('Power_quality', 'Power quality', 'power quality'),
  ie: W('Premium_efficiency', 'IE efficiency classes', 'Premium efficiency'),
  duty: W('Duty_cycle', 'Duty cycle (S1-S10)', 'duty cycle'),
}
// Implicit pe familie; suprascris punctual mai jos pentru module specifice.
const FAM_DOCS = {
  asincron: [ABB.no4, WEB.induction],
  pompe: [WEB.centrifugal, WEB.affinity],
  cc: [WEB.dcMotor],
  servo: [ABB.no9, WEB.foc],
  sincron: [WEB.syncMotor],
  comun: [ABB.no7],
}
const DOC_LINKS = {
  'putere-curent': [ABB.no4, WEB.pf],
  'cuplu': [ABB.no7, WEB.induction],
  'sarcina-afinitate': [ABB.no7, WEB.affinity],
  'incarcare': [ABB.no7],
  'dinamica': [ABB.no7, WEB.inertia],
  'energie-roi': [ABB.no7, WEB.affinity],
  'vfd': [ABB.no4, WEB.vfd],
  'cablu': [WEB.cable],
  'termic': [ABB.no7, WEB.duty],
  'armonici': [ABB.no6, WEB.thd],
  'compensare': [WEB.pf],
  'transmisii': [ABB.no7, WEB.inertia],
  'selectie-drive': [ABB.no7],
  'raport-inertie': [ABB.no7, WEB.inertia],
  'turatie-critica': [ABB.no4, WEB.resonance],
  'conversii': [],
  'motor-echivalent': [WEB.induction],
  'bilant-putere': [WEB.induction],
  'teste-parametri': [WEB.induction],
  'randament-sarcina': [ABB.no7, WEB.induction],
  'dezechilibru': [WEB.powerQuality],
  'npsh': [WEB.npsh],
  'turatie-specifica': [WEB.specificSpeed],
  'compresor-volant': [ABB.no7, WEB.flywheel],
  'pmsm-model': [ABB.no9, WEB.foc],
  'pmsm-feedback': [ABB.no9, WEB.encoder],
  'acordare-pi': [WEB.pid],
  'raspuns-ord2': [WEB.damping],
  'pmsm-camp-slabit': [ABB.no9, WEB.foc],
  'profil-miscare': [ABB.no9],
  'ipmsm-mtpa': [WEB.foc],
  'suprasarcina-servo': [ABB.no9, WEB.duty],
  'synrm': [WEB.reluctance],
  'cablu-protectii': [WEB.cable],
  'scurtcircuit': [WEB.shortCircuit],
  'ieee519': [ABB.no6, WEB.thd],
  'rezonanta-cond': [ABB.no6, WEB.resonance],
  'transformator': [WEB.transformer],
  'dip-pornire': [WEB.voltageSag],
  'comutatie': [WEB.inverter],
  'unda-reflectata': [ABB.no4],
  'ride-through': [ABB.no8],
  'curenti-rulment': [ABB.no4],
  'surub-bile': [ABB.no7, WEB.inertia],
  'liniar-raza': [ABB.no7],
  'macara': [ABB.no8],
  'transportor': [ABB.no7],
  'winder': [ABB.no7],
  'frecare': [ABB.no7],
  'kinetic-buffer': [ABB.no8],
  'contragreutate': [ABB.no8],
  'taper': [ABB.no1],
  'reactor-detunare': [ABB.no6, WEB.resonance],
  'factor-k': [ABB.no6, WEB.thd],
  'factor-putere-vfd': [ABB.no6, WEB.pf],
  'comparatie-frontend': [ABB.no6, WEB.thd],
  'filtru-iesire': [ABB.no4, WEB.inverter],
  'clase-ie': [WEB.ie],
  'derating-vfd-motor': [ABB.no4, WEB.induction],
  'cosphi-sarcina': [WEB.pf],
  'derating-armonici-motor': [WEB.thd],
  'regimuri-s': [WEB.duty],
  'porniri-ora': [ABB.no7],
