...
export const MODULES = [
  ...
  },
  {
    ...
    results: [
      { key: 'HVF', label: 'Harmonic Voltage Factor', unit: '', tex: 'HVF = \\sqrt{\\sum V_n^2/n}',
  ...
  },
  {
    ...
    results: [
      ...
      { key: 'Tmotor', label: 'Cuplu la motor', unit: 'Nm', tex: 'T = F\\,r/\\eta',
  ...
  },
  {
    ...
    results: [
      ...
      { key: 'T', label: 'Cuplu (la d)', unit: 'Nm', tex: 'T = F(d)\\,d/2',
