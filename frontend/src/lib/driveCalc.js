...
const STD = {
  ...
  iec61800_2: { protected: true, label: 'IEC 61800-2 — sisteme de actionare (PDS), rating (extras)', href: _stdView('iec61800-2-extras.pdf', 'power drive systems') },
  iec61800_3: { protected: true, label: 'IEC 61800-3 — EMC, categorii C1-C4 (extras)', href: _stdView('iec61800-3-extras.pdf') },
  iec61800_5_1: { protected: true, label: 'IEC 61800-5-1 — siguranta electrica & termica (extras)', href: _stdView('iec61800-5-1-extras.pdf', 'safety requirements') },
  ...
  iec61000_4_30: { protected: true, label: 'IEC 61000-4-30 — masurarea calitatii energiei (extras)', href: _stdView('iec61000-4-30-extras.pdf', 'power quality') },
  iec60076_1: { protected: true, label: 'IEC 60076-1 — transformatoare de putere (extras)', href: _stdView('iec60076-1-extras.pdf', 'power transformer') },
  iso9906: { protected: true, label: 'EN ISO 9906 — incercari pompe, NPSH (extras)', href: _stdView('iso9906-extras.pdf', 'NPSH') },
  en50160: { protected: true, label: 'EN 50160 — caracteristicile tensiunii retelei (extras)', href: _stdView('en50160-extras.pdf', 'voltage characteristics') },
}
const STD_DOCS = {
