...
const ABB = {
  ...
  no4: { label: 'ABB Technical Guide No.4 — Variable Speed Drives', href: abbView('throttling or bypass control', 172) },
  ...
  no8: { label: 'ABB Technical Guide No.8 — Electrical Braking', href: abbView('Flux braking is a method based on motor losses', 321) },
