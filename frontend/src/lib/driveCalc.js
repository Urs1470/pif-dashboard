...
const W = (slug, label) => ({ label: `${label} (Wikipedia EN)`, href: `https://en.wikipedia.org/wiki/${slug}` })
const WEB = {
  induction: W('Induction_motor', 'Induction motor'),
  affinity: W('Affinity_laws', 'Affinity laws'),
  npsh: W('Net_positive_suction_head', 'NPSH'),
  thd: W('Total_harmonic_distortion', 'Total harmonic distortion'),
  pf: W('Power_factor', 'Power factor'),
  dcMotor: W('DC_motor', 'DC motor'),
  syncMotor: W('Synchronous_motor', 'Synchronous motor'),
  foc: W('Vector_control_(motor)', 'Vector control / FOC'),
  vfd: W('Variable-frequency_drive', 'Variable-frequency drive'),
  centrifugal: W('Centrifugal_pump', 'Centrifugal pump'),
  specificSpeed: W('Specific_speed', 'Specific speed'),
  shortCircuit: W('Short_circuit', 'Short circuit'),
  transformer: W('Transformer', 'Transformer'),
  reluctance: W('Reluctance_motor', 'Reluctance motor (SynRM)'),
  inertia: W('Moment_of_inertia', 'Moment of inertia'),
  resonance: W('Resonance', 'Resonance'),
  encoder: W('Rotary_encoder', 'Rotary encoder'),
  pid: W('PID_controller', 'PID controller'),
  damping: W('Damping', 'Damping ratio'),
  inverter: W('Power_inverter', 'Power inverter / IGBT'),
  cable: W('Voltage_drop', 'Voltage drop'),
  flywheel: W('Flywheel', 'Flywheel'),
  voltageSag: W('Voltage_sag', 'Voltage sag'),
  powerQuality: W('Power_quality', 'Power quality'),
  ie: W('Premium_efficiency', 'IE efficiency classes'),
  duty: W('Duty_cycle', 'Duty cycle (S1-S10)'),
}
