...
<style>
  ...
  .imp-eq-tag { font-style: normal; font-size: var(--font-small); font-weight: var(--fw-semibold); padding: 1px 7px; border-radius: var(--radius-full); background: var(--accent-subtle); color: var(--accent-on-subtle); }
